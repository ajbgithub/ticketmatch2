...
-- Optional alternative to Auth Hook: DB trigger on auth.users
-- This makes seeding automatic without configuring an Auth Hook in the dashboard.
-- Safe to keep enabled with the hook because we use ON CONFLICT DO NOTHING.
