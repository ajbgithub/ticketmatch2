      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <section className="space-y-6 text-[15px] leading-6">
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>To create matches and display contact info to matched parties.</li>
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>Your contact details are only shown to counterparties on a match.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              TicketMatch does not handle payments or ticket transfers. If you complete
              a trade off platform (e.g., Venmo, SMS), you do so at your own risk.
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                Listings and matches in this phase are capped at <strong>0–100% of face value</strong>.
              </li>
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>
                By creating an account and checking the consent box, you agree we may
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <li>Account/profile deletion is available on request; some logs may persist briefly.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc space-y-1 pl-5">
              <li>No harassment, spam, fraud, or bypassing platform rules.</li>
              <li>Only post tickets you control and are allowed to transfer.</li>
            </ul>
          </div>
          ...
          <div className="text-sm text-gray-600">
            By creating an account or continuing to use TicketMatch, you agree to this Privacy &amp; User Policy.
          </div>
