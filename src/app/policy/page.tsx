  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-900">
      <div className="max-w-3xl mx-auto px-6 py-10">
        <h1 className="text-3xl font-extrabold mb-2">Privacy & User Policy</h1>
        ...
        <section className="space-y-6 text-[15px] leading-6">
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Listings/requests: role (buyer/seller), percent of ticket value (0–100%), number of tickets, and event.</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>To create matches between buyers and sellers and display contact info to matched parties.</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Your contact details (phone, Venmo) are only shown to the counterparties when a direct match is surfaced to you.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              TicketMatch does not handle payments or ticket transfers. If you
              choose to complete a trade off platform (e.g., Venmo, SMS), you do so
              at your own risk. Always verify counterparties and keep records.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>Listings and matches in this phase are capped at **0–100% of face value**.</li>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                By creating an account and checking the consent box, you agree that we
                may store your contact information and display it to your matches.
              </li>
              <li>
                If/when SMS is enabled, you agree to opt-in with
                carrier disclosures. Standard message/data rates may apply.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Account/profile deletion is available on request; operational logs may persist for a limited period.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              <a className="underline" href="mailto:ajbgithub@gmail.com">mbamoveteam@gmail.com</a>.
            </p>
          </div>
