...
export default function TicketMarket() {
  ...
  const allEvents = useMemo(() => {
    ...
    return serverEvents.length ? serverEvents : BASE_EVENTS;
  }, [serverEvents]);
      ...
      <div className="mx-auto max-w-7xl p-6 md:p-8">
        ...
        <div className="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
          <Card className="p-4">
            ...
            <div className="mt-1 text-sm text-gray-600">- Kukua T. WG26</div>
          </Card>
          <Card className="p-4">
            ...
            <div className="mt-1 text-sm text-gray-600">- Loic T. WG27</div>
          </Card>
        </div>
                  ...
                  <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
                    ...
                    <div>
                      <Select value={newEventType} onChange={(e)=>setNewEventType(e.target.value as any)}>
                        ...
                        <option value="ceiling">Ceiling pricing</option>
                      </Select>
                    </div>
                    {newEventType === 'ceiling' && (
                      <div className="md:col-span-1">
                        <Input type="number" placeholder="Member $" value={newEventPrice} onChange={(e)=>setNewEventPrice(Number(e.target.value))} />
                      </div>
                    )}
                    <div className="md:col-span-1">
                      <Button type="button" onClick={async ()=>{
                        ...
                        if (similar) { alert('A similar event is already being traded. Try a different name.'); return; }
                        try {
                          ...
                          alert('Event creation is not configured. See migrations.sql');
                        }
                      }}>Create</Button>
                    </div>
                  </div>
